...
2749
632
Percentage landlords
(count owners with [length my-ownership > 1] * 100) / (count owners with [is-house? my-house])
17
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (count owners with [length my-ownership > 1] * 100) / (count owners with [is-house? my-house])"
...
172
795
Number of realtors and territory
9
0.0
1
...
388
405
Households' on-market behaviours
9
0.0
1
...
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
  ...
  <experiment name="240528_Baseline" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    ...
    <metric>median [rent-price] of houses with [myType = "rent" and for-rent? = true]</metric>
    <metric>median [rent-price] of houses with [myType = "rent"]</metric>
    <metric>median [wealth] of owners with [is-house? my-house]</metric>
    <metric>(count owners with [length my-ownership &gt; 1] * 100) / (count owners with [is-house? my-house])</metric>
    <enumeratedValueSet variable="ActWhenShocked">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Affordability">
  ...
  <experiment name="240528_InterestAt300_3.7to8" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_8to3.7" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_60to90" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_90to60" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_3.7to8_varyInitial" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_8to3.7_varyInitial" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_60to90_varyInitial" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_90to60_varyInitial" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_3.7to8to3.7" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]
if (ticks / TicksPerYear) = (mYear + 5) [set InterestRate 3.7]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
    <metric>count owners with [mytype = "mortgage"]</metric>
  ...
  <experiment name="240528_LTVat300_90to60to90" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]
if (ticks / TicksPerYear) = (pYear + 5) [set MaxLoanToValue 90]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
    <metric>count owners with [mytype = "mortgage"]</metric>
  ...
  <experiment name="240528_InterestAt300_8to3.7_varyLTV" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_3.7to8_varyLTV" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_Baseline_varyInvestors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240528_InterestAt300_3.7to8_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_8to3.7_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_60to90_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_LTVat300_90to60_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_InterestAt300_3.7to8to3.7_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]
if (ticks / TicksPerYear) = (mYear + 5) [set InterestRate 3.7]</go>
  ...
  <experiment name="240528_LTVat300_90to60to90_20investors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]
if (ticks / TicksPerYear) = (pYear + 5) [set MaxLoanToValue 90]</go>
  ...
  <experiment name="240528_Baseline_varyLTV_varyInvestors" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240603 PatternOriented_interest" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240603 PatternOriented_LTV" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="240528_Baseline_varyLTV" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240603_Baseline_varyIncome" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240603_Baseline_varyInterest" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
